...
public class RecursiveSortedList<T extends Comparable<? super T>> implements SortedListService<T> {
    ...
    public static void main(String[] args) {
        RecursiveSortedList<Integer> list = new RecursiveSortedList<>();
        ...
        System.out.println("Tamaño actual: " + list.size()); // 5
        System.out.println("Mínimo: " + list.getMin());      // 5
        System.out.println("Máximo: " + list.getMax());      // 20

        System.out.println("\nBuscando elementos...");
        System.out.println("¿Contiene 15? " + list.find(15)); // true
        System.out.println("¿Contiene 7? " + list.find(7));   // false

        System.out.println("\nIntentando insertar duplicados...");
        boolean inserted = list.insert(10);
        System.out.println("Insertar 10 de nuevo: " + inserted); // false

        System.out.println("\nEliminando elementos...");
        System.out.println("Eliminar 5: " + list.remove(5));   // true
        System.out.println("Eliminar 42: " + list.remove(42)); // false
        System.out.println("Nuevo tamaño: " + list.size());    // 4

        System.out.println("\n¿Está vacía? " + list.isEmpty()); // false

        System.out.println("\nElementos ordenados (dump manual):");
        Node<Integer> current = list.list;  // acceso directo solo para test
        while (current != null) {
