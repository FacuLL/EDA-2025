...
public class BinaryTree<T> implements BinaryTreeService<String> {
    ...
    static class Node {
		...
		public boolean equals(Object obj) {
			...
			return node.data.equals(data) && Objects.equals(node.right, right) && Objects.equals(node.left, left);
		}
	}  // end Node class
	...
	private Integer getHeight(Node actual) {
		...
		return Math.max(actual.left == null ? 0 : getHeight(actual.left), actual.right == null ? 0 : getHeight(actual.right)) + 1;
	}
	...
	public void toFile(String fileName) throws IOException, URISyntaxException {
		String path = "C:/Users/facul/Desktop/Proyectos/EDA-2025/Algoritmos/P2/BinaryTree/src/main/resources/" + fileName;
	...
	public static void main(String[] args) throws FileNotFoundException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		...
		try {
			rta.toFile("output.txt");
		} catch(Exception e) {
			throw new RuntimeException(e);
		}

		BinaryTreeService otro = new BinaryTree("output.txt");
